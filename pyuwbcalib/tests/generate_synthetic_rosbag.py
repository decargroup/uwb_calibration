...
with rosbag.Bag('datasets/synthetic/ros_bags/synthetic1.bag', 'w') as bag:
    for row in range(df.shape[0]):
        ############## UWB 1 ##############
        if not np.isnan(df['timestamp_1'][row]):
        ...
        ############## UWB 2 ##############
        if not np.isnan(df['timestamp_2'][row]):
        ...
        ############## Mocap Data 1 ##############
        if not np.isnan(df['timestamp_mocap_1'][row]):
        ...
        ############## Mocap Data 2 ##############
        if not np.isnan(df['timestamp_mocap_2'][row]):
        ...
        ############## Mocap Data 3 ##############
        if not np.isnan(df['timestamp_mocap_3'][row]):
